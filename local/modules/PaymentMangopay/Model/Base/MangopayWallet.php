...
abstract class MangopayWallet implements ActiveRecordInterface 
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MangopayWalletTableMap::translateFieldName('TheliaSeller', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = MangopayWalletTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setTheliaSeller($arr[$keys[3]]);
    }
